          ...
          <div className="space-y-6 mt-12">
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl border-2 border-white/20">
              ...
              <div className="mt-6 flex flex-col items-center gap-2">
                <a href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent('Halo, saya tertarik dengan layanan Skytech Indonesia.')}`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 py-4 px-8 bg-[#25D366] text-white font-bold text-lg rounded-[50px] shadow-lg hover:scale-105 hover:shadow-xl transition-all">
                  <span className="text-2xl">💬</span>
                  <span>WhatsApp saya</span>
                </a>
                <button type="button" onClick={openWaModal} className="text-sm text-white/80 hover:text-[#00bcd4] underline underline-offset-2 transition-colors">
                  Atau isi pesan terlebih dahulu
                </button>
              </div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl border-2 border-white/20">
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
            <div className="p-6 sm:p-8">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-xl font-bold text-[#003d6b]">Hubungi via WhatsApp</h3>
